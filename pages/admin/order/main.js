...
export default function OrdersPage({ editOrder }) {
  ...
  return (
    <>
      <div>
        {editOrder.id ? <Button variant="warning" onClick={handleShow}> Edit Product in Store </Button> : '' }
      </div>
      <div>
          ...
          <Form>
            ...
            <FloatingLabel controlId="floatingSelect" label="state">
              ...
              >
                ...
                <option value="USA">CA</option>
                <option value="CANADA">NY</option>
                <option value="FRANCE">TN</option>
                <option value="ENGLAND">NH</option>
                <option value="SPAIN">FL</option>
                <option value="FINLAND">MI</option>
                <option value="SWITZERLAND">GA</option>
                <option value="KENYA">WA</option>
                <option value="BRAZIL">VT</option>
              </Form.Select>
            </FloatingLabel>
